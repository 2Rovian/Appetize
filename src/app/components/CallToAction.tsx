    ...
    return (
        <section className="h-[150px] mt-5 w-full bg-amber-700 rounded-md text-gray-100 flex items-center justify-center">
            <div className="flex flex-col justify-center items-center mx-10 text-center">
                ...
                <button className="px-6 py-2 bg-white text-amber-700 rounded-md font-bold cursor-pointer mt-2 md:mt-3 hover:bg-amber-500 hover:text-white hover:shadow-[0_0_10px_rgba(255,193,7,0.5)] transition duration-300 ease-in-out">Sign Up Now</button>
            </div>
        </section>
    )
}